...
pub const SHADER_PS1: (&str, &str) = preprocess_shader_vf!(include_bytes!("../../resources/shaders/ps1.glsl"));
pub const SHADER_PS1_TESSELLATE: (&str, &str, &str, &str) = preprocess_shader_vtf!(include_bytes!("../../resources/shaders/ps1.glsl"));
